...
public class LiveScriptInterpolatedStringExpressionImpl extends LiveScriptExpressionImpl implements LiveScriptInterpolatedStringExpression {
  ...
  @Override
  @NotNull
  public LiveScriptInterLines getInterLines() {
    return findNotNullChildByClass(LiveScriptInterLines.class);
  }

  @Override
  @NotNull
  public List<LiveScriptInterStringExpression> getInterStringExpressionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LiveScriptInterStringExpression.class);
  }
